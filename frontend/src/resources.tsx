...
//   columns: [
//     { key: 'company_name', label: 'نام شرکت', field: 'company_name' },
...
//   ],
//   fields: [
//     { key: 'company_name', label: 'نام شرکت', required: true },
//     { key: 'address', label: 'آدرس', required: true },
//     { key: 'phone', label: 'تلفن', required: true },
...
//   fields: [
//     {
//       key: 'id_company', label: 'نام شرکت', type: 'reference', required: true,
//       reference: {
//         path: '/transport-companies', valueKey: 'id_company', labelKey: 'company_name',
//       },
//     },
//     { key: 'name', label: 'نام', required: true },
//     { key: 'family', label: 'نام خانوادگی', required: true },
...
const companyRepresentatives: CrudConfig<CompanyRepresentative> = {
  ...
  fields: [
    {
      key: 'id_company', label: 'نام شرکت', type: 'reference',
      reference: {
        path: '/transport-companies', valueKey: 'id_company', labelKey: 'company_name',
      },
    },
